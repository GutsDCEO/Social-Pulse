...
const adminNavGroups: NavGroup[] = [
  ...
  },
  {
    label: "Opérations",
    items: [
      { title: "Vue d'ensemble", url: "/admin", icon: Activity },
      { title: "Cabinets", url: "/admin/cabinets", icon: Building2 },
      { title: "Utilisateurs", url: "/admin/users", icon: Users },
      { title: "Prises de parole", url: "/admin/publications", icon: ScrollText },
      { title: "CM & Activité", url: "/admin", icon: Activity },
    ],
  },
  {
    label: "Business",
    items: [
      ...
      { title: "Revenus & MRR", url: "/admin", icon: TrendingUp },
      { title: "Facturation", url: "/admin", icon: Receipt },
      { title: "Acquisition & Pipeline", url: "/admin", icon: Target },
      { title: "Rétention & Churn", url: "/admin", icon: UserMinus },
      { title: "KPIs SaaS", url: "/admin", icon: BarChart3 },
    ],
  },
  {
    label: "Coordination",
    items: [
      { title: "Centre de coordination", url: "/admin", icon: MessageSquare },
    ],
  },
  {
    label: "Conformité",
    items: [
      ...
      { title: "Journal d'activité", url: "/admin/compliance", icon: History },
    ],
  },
  {
    label: "Paramètres",
    items: [
      { title: "Vue d'ensemble", url: "/admin/settings", icon: Settings },
      { title: "Notifications", url: "/admin/settings", icon: Bell },
      { title: "Canaux & intégrations", url: "/admin/settings", icon: ArrowRightLeft },
    ],
  },
];
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
              ...
              tooltip={collapsed ? "Paramètres compte" : undefined}
              className={cn(
                "w-full justify-start gap-2.5 rounded-md px-2.5 py-1.5 text-[13px] transition-colors",
                isActive("/settings")
                  ? "bg-sidebar-accent text-sidebar-accent-foreground font-medium"
            ...
            >
              <Link to="/settings">
                ...
                {!collapsed && <span>Paramètres compte</span>}
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
