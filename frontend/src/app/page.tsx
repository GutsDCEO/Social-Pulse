...
import {
  BarChart3, Calendar, MessageSquare, TrendingUp,
  Users, Zap, ChevronRight, Check, ArrowRight
} from "lucide-react";
    ...
    <div style={{ background: "#0f0f1a", minHeight: "100vh", color: "#f1f1f1" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 1.5rem", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
            ...
            <span style={{ fontWeight: 700, fontSize: "1.2rem" }}>
              Social<span style={{ color: "#a78bfa" }}>Pulse</span><span style={{ color: "#ec4899", fontSize: "0.7rem", marginLeft: 2 }}>.pro</span>
            </span>
          </div>
          <div style={{ display: "flex", gap: "0.75rem", alignItems: "center" }}>
            <Link href="/auth/login" className="btn-secondary" style={{ padding: "0.5rem 1.25rem", fontSize: "0.9rem" }}>Connexion</Link>
            <Link href="/auth/register" className="btn-primary" style={{ padding: "0.5rem 1.25rem", fontSize: "0.9rem" }}>Essayer gratuitement</Link>
          </div>
        </div>
      </nav>
      ...
      <section style={{ maxWidth: 1200, margin: "0 auto", padding: "6rem 1.5rem 4rem", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
          <Link href="/auth/register" className="btn-primary" style={{ fontSize: "1.05rem", padding: "0.9rem 2rem" }}>
            Essayer gratuitement <ArrowRight size={18} />
          </Link>
          <a href="#demo" className="btn-secondary" style={{ fontSize: "1.05rem", padding: "0.9rem 2rem" }}>
            Demander une démo
          </a>
        </div>
      ...
      <section id="tarifs" style={{ maxWidth: 1200, margin: "0 auto", padding: "4rem 1.5rem" }}>
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.55)", fontSize: "1.1rem" }}>Commencez gratuitement, évoluez selon vos besoins.</p>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px,1fr))", gap: "1.5rem", alignItems: "start" }}>
          {plans.map(plan => (
            <div key={plan.name} className="card" style={{ position: "relative", border: plan.popular ? "1px solid #7c3aed" : undefined }}>
              ...
              <Link href="/auth/register" className={plan.popular ? "btn-primary" : "btn-secondary"} style={{ width: "100%", justifyContent: "center" }}>
      ...
      <section id="demo" style={{ maxWidth: 700, margin: "0 auto", padding: "4rem 1.5rem" }}>
        <div className="card" style={{ textAlign: "center" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.55)", marginBottom: "2rem" }}>Notre équipe vous contacte sous 24h pour une démonstration personnalisée.</p>
          {demoSent ? (
            <div style={{ color: "#a78bfa", fontWeight: 600, fontSize: "1.1rem" }}>
              <Check size={32} style={{ margin: "0 auto 0.5rem", display: "block" }} />
              Merci ! Nous vous contacterons très bientôt.
            </div>
          ) : (
            <form onSubmit={handleDemo} style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap", justifyContent: "center" }}>
              <input
                type="email"
                className="input"
